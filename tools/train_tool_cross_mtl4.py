...
def train(parameters, config, gpu_list, do_test=False, local_rank=-1, **params):
    ...
    for epoch_num in range(trained_epoch, epoch):
        ...
        dataloader_1, dataloader_2, dataloader_3, dataloader_4 = parameters['train_dataset']
        datasloader_zipped = zip(dataloader_1,dataloader_2,dataloader_3,dataloader_4)
        
        #for shuffle
        for dataloader in (dataloader_1,dataloader_2,dataloader_3,dataloader_4):
        ...
        #각 batch 에 대하여 
        for step, (dataloader_1, dataloader_2, dataloader_3,dataloader_4) in enumerate(datasloader_zipped):
            # tensor to cuda
            for dataloader in (dataloader_1, dataloader_2, dataloader_3,dataloader_4): #datas = [source,target]
            ...
            if "T5" in config.get("target_model","model_base"):
                for idx,(source_dataset,target_dataset) in enumerate([dataloader_1,dataloader_2,dataloader_3,dataloader_4]):
