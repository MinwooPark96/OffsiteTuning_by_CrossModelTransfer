...
def drawplot_train_loss(length,json_name,nbins):
    ...
    plt.title('Train Loss', fontdict=title_font, loc='left', pad=20)

    
    plt.savefig(json_name+"/train_loss.png", bbox_inches = 'tight', dpi = 250, facecolor = ax.get_facecolor())